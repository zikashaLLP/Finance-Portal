          ...
          <tbody>
            {rows.length === 0 ? (
              ...
              <tr key={o.id} className={cn("border-b border-border last:border-0 hover:bg-muted/20 transition-colors", i % 2 !== 0 && "bg-muted/10")}>
                <td className="px-5 py-3.5 font-mono text-xs font-semibold text-foreground">{o.orderNumber}</td>
                <td className="px-5 py-3.5 text-foreground">{o.karigarName}</td>
                <td className="px-5 py-3.5 text-muted-foreground max-w-[180px] truncate">{o.itemName}</td>
                <td className="px-5 py-3.5 tabular-nums text-muted-foreground">{fmtW(o.goldWeight)}</td>
                <td className="px-5 py-3.5 tabular-nums text-muted-foreground">{o.diamond > 0 ? fmtCt(o.diamond) : "0ct"}</td>
                <td className="px-5 py-3.5">
          ...
          <tbody>
            {rows.length === 0 ? (
              ...
              <tr key={o.id} className={cn("border-b border-border last:border-0 hover:bg-muted/20 transition-colors", i % 2 !== 0 && "bg-muted/10")}>
                <td className="px-5 py-3.5 font-mono text-xs font-semibold text-foreground">{o.orderNumber}</td>
                <td className="px-5 py-3.5 text-foreground">{o.karigarName}</td>
                <td className="px-5 py-3.5 text-muted-foreground">{o.client}</td>
                <td className="px-5 py-3.5 text-muted-foreground">{o.itemType}</td>
                <td className="px-5 py-3.5">
                ...
                <td className="px-5 py-3.5 text-muted-foreground whitespace-nowrap">{o.completionDate}</td>
                <td className="px-5 py-3.5">
                  <div className="flex items-center gap-1">
