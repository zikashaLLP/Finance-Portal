    ...
    <div className="min-h-screen bg-muted/30">
      <div className="bg-background border-b border-border px-6 py-5">
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground tracking-tight leading-tight">General Management</h1>
            <p className="text-sm text-muted-foreground mt-0.5">Manage jewellery categories, types, purity, and diamond filters</p>
          </div>
        </div>
