      ...
      <div className="px-8 pt-6 pb-5 border-b border-border shrink-0 flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-semibold text-foreground tracking-tight">Transaction Reports</h1>
          </div>
            ...
            {generated && (
              <div className="bg-card border border-border rounded-xl overflow-hidden">
                ...
                <div className="px-6 py-4 border-t border-border bg-muted/20 flex gap-3">
                  <button className="flex-1 h-9 rounded-lg border border-border text-sm font-medium text-foreground hover:bg-sidebar-accent transition-colors">
                    Download PDF
                  </button>
                  <button className="flex-1 h-9 rounded-lg border border-border text-sm font-medium text-foreground hover:bg-sidebar-accent transition-colors">
                    Export Excel
