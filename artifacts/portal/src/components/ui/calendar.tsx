  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          "select-none font-medium w-full h-[--cell-size] flex items-center justify-center",
          captionLayout === "label"
            ? "text-sm"
            : "[&>svg]:text-muted-foreground flex h-8 items-center justify-center gap-1 rounded-md pl-2 pr-1 text-sm [&>svg]:size-3.5",
